...
// ─── C FFI bindings ────────────────────────────────────────────────────────
//
// NOTE: These declarations are auto-generated by cbindgen from src/lib.rs.
// To regenerate: `cargo run --bin generate-header -p tpt-torus-cxx`
// The generated header is written to include/torus_generated.h.
// If modifying FFI functions in lib.rs, regenerate this section.
